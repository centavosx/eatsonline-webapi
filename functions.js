...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        clientId: "184126786610-srtof6p7p1o89skesva310r1kv76thgf.apps.googleusercontent.com",
        clientSecret: "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",
        refreshToken: "1//04_nQUPQ72KNTCgYIARAAGAQSNwF-L9IrdKkxp-_21CjNGJvrqG22k0BZ9OMejF21yumA0kQWBJ49R412IdxZv_rpWTvUe-cgoDM",
        accessToken: "ya29.A0ARrdaM93NXpMRAwuksJz7kzKzZKzAEVmSUixiMJ68r-xD2bJvTskENrvMHyTuLkKS72M6GoFLtDevRms-oldWhw8in3eQuj67Pz1py68hPHlRlHtn1j3-0eK5shbRYbreLUaF9-bnpk1LTvp0HsJ762tJQPq"
    },
    tls:{
...
const encryptJSON = (text) =>{
  const passphrase = "EatsOnline2020";
  return {data: CryptoJS.AES.encrypt(JSON.stringify(text), passphrase).toString()};
}
module.exports = {
    generateCode,
    checkLastKey,
